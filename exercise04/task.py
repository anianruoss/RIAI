...
# Add the data normalization as a first "layer" to the network allowing to
# search for adverserial examples to the real image, rather than to the
# normalized image
...
def pgd_untargeted(model, x, labels, k, eps, eps_step, clip_min=None,
